export const config = {
    ...
    author: {
        ...
        social: [
            ...
            { id: 3, label: "Facebook", url: "https://facebook.com/lunarairisu", icon: "fa-brands fa-facebook" },
            { id: 4, label: "Email", url: "mailto:ruunapham@gmail.com", icon: "fa-solid fa-envelope" }
        ]
    },
    routes: [
